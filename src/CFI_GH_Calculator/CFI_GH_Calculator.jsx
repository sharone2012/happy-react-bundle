...
export default function CFI_GH(){
  ...
  const r       = useSelector(function(s) { return s.calc.results['gh'] || {capex:{}}; });
  const loading = useSelector(function(s) { return s.calc.loading['gh'] || false; });
  useEffect(()=>{
    dispatch(runCalc({ name:'gh', body:{feedTpd,feedMc,s3Days,s4Days,s3Frac,bedDepth,bulkDen,ghW,ghL,laneW,
     ...
     truckPayload,nTrucks,haulDist,truckSpd,tipTime,truckCost,
     miniTph,miniCost,ghStruct,sprRate,slab150Mat,slab150Lab,slab200Mat,slab200Lab,dispatch]);
