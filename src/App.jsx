...
const LABEL_STYLE = { display:"block", color:C.grey, fontSize:10, fontWeight:600,
...
export default function CFI() {
  ...
  const s2Conflicts = [];
  if(s2.naoh) s2Conflicts.push({id:"naoh_alert",sev:"amber",msg:"⚠️ NaOH active — Na⁺ residues toxic to BSF above 0.3% DM. Mandatory rinse cycle required before BSF introduction. Monitor substrate Na after neutralisation."});  // BUG-06 FIX: GR-11 — NaOH = AMBER not red
              ...
              <div style={{display:"flex", flexDirection:"column", gap:16}}>
                ...
                <Card>
                  ...
                  <div style={g4}>
                    ...
                    <ResidueCard label="PMF"   active={s0.pmfEnabled}  onClick={()=>upS0("pmfEnabled",!s0.pmfEnabled)}              sublabel="Mesocarp fibre"/>
                    <ResidueCard label="POME"  active={false}          onClick={()=>{}}  locked sublabel="Liquid — sent to pond"/>
                    <ResidueCard label="PKM"   active={s0.pkeEnabled}  onClick={()=>upS0("pkeEnabled",!s0.pkeEnabled)}              sublabel="Palm kernel meal"/>
                  </div>
                  <Divider/>
                  {/* D — Blend Analysis */}
                  <div style={{textAlign:"center", marginBottom:8}}>
                    <div style={{color:C.teal, fontWeight:800, fontSize:13, letterSpacing:"0.03em"}}>D — Blend analysis</div>
                    <div style={{color:C.grey, fontSize:10, marginTop:4}}>Enter % split between active streams (DM basis — must total 100%)</div>
                  </div>
                  <div style={{display:"grid", gridTemplateColumns:"1fr 1fr 1fr 1fr", gap:10, marginBottom:12}}>
                    ...
                    {/* POS */}
                    <div style={{display:"flex", flexDirection:"column", alignItems:"center", gap:4}}>
                      <div style={{color:"#4A9EDB", fontWeight:700, fontSize:11, textAlign:"center"}}>POS</div>
                    ...
                    {/* PKM */}
                    <div style={{display:"flex", flexDirection:"column", alignItems:"center", gap:4}}>
                      <div style={{color:"#9B59B6", fontWeight:700, fontSize:11, textAlign:"center"}}>PKM</div>
                    ...
                    {pomeActive && (
                      <div style={{display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:8, marginTop:10}}>
                        <div style={{textAlign:"center"}}>
                          <div style={{color:C.grey, fontSize:9, letterSpacing:"0.04em", marginBottom:3}}>DM required</div>
                          <div style={{color:"#4A9EDB", fontWeight:900, fontFamily:"monospace", fontSize:13}}>{pomeDMreq} t/day</div>
                        </div>
                        <div style={{textAlign:"center"}}>
                          <div style={{color:C.grey, fontSize:9, letterSpacing:"0.04em", marginBottom:3}}>Wet t/day @ {pomeSludgeActMC}% MC</div>
                        ...
                        <div style={{textAlign:"center"}}>
                          <div style={{color:C.grey, fontSize:9, letterSpacing:"0.04em", marginBottom:3}}>Dilution factor</div>
                ...
                <Card>
                  ...
                  <Divider/>
                  <div style={{display:"block", color:C.grey, fontSize:10, fontWeight:700, letterSpacing:"0.04em", marginBottom:8}}>Agronomy management Tier</div>
            ...
            <div style={{display:"flex", flexDirection:"column", gap:16, marginTop:16}}>
              ...
              <Card>
                ...
                <Divider/>
                  ...
                  <div>
                    <div style={{display:"block", color:C.grey, fontSize:10, fontWeight:700, letterSpacing:"0.04em", marginBottom:5}}>Moisture state</div>
                    <PillToggle
