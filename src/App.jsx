...
const ResidueCard = ({abbr, label, labelJsx, active, locked, onClick, highlightColor, fontSize:fs}) => {
  ...
  <div onClick={locked?undefined:onClick}
    style={{background: active ? "#0F2236" : "#000000",
                ...
                <Card>
                  ...
                  <div style={g2}>
                    ...
                    <input style={{background:C.inputBg, border:`1px solid ${C.teal}55`, borderRadius:6,
                      ...
                      placeholder="Processing Mill's Name"/>
                  </div>
              ...
              <div style={{display:"flex", flexDirection:"column", gap:16}}>
                ...
                <Card>
                  ...
                  <div style={{...g3, marginTop:10}}>
                    ...
                    <ResidueCard abbr="POME" labelJsx={<><span>LIQUID</span><br/><span style={{color:C.amber, fontWeight:700}}>Discharged to Pond</span></>} active={s0.pomeLiquidEnabled} onClick={()=>upS0("pomeLiquidEnabled",!s0.pomeLiquidEnabled)} highlightColor="#4A9EDB"/>
