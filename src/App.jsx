...
const ResidueCard = ({abbr, label, labelJsx, active, locked, onClick, highlightColor, fontSize:fs}) => {
  ...
  <div onClick={locked?undefined:onClick}
    ...
    <div style={{display:"flex", alignItems:"center", justifyContent:"space-between", gap:8}}>
      <div style={{color:col, fontWeight:900, fontSize:fs||13, textTransform:"uppercase",
    ...
    : label && abbr && <div style={{color:"#7a9aae", fontWeight:700, fontSize:9.5, textTransform:"uppercase",
              ...
              <div style={{display:"flex", flexDirection:"column", gap:16}}>
                ...
                <Card>
                  ...
                  <div style={g3}>
                    ...
                    <ResidueCard abbr="POS" label={"POME\nSLUDGE"} active={pomeActive} onClick={()=>upS0("pomeEnabled",!s0.pomeEnabled)} highlightColor={C.teal}/>
