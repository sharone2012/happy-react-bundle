      ...
      <div style={{padding:"16px 22px 60px", minWidth:1400, margin:"0 auto"}}>
        ...
        {stage===0 && (()=>{
          ...
          <div>
            ...
            {/* ── STICKY S0 HEADER ── */}
            <div style={{background:C.pageBg, borderBottom:`1px solid ${C.teal}22`,
                  ...
                  <div style={{display:"flex", flexDirection:"column", gap:6}}>
                    {AG_TIERS.map(ag=>(
                      <div key={ag.id} onClick={()=>upS0("ag",ag.id)}
                        style={{background:s0.ag===ag.id?C.amber+"18":C.pageBg,
                        ...
                        <tr style={{background:C.pageBg}}>
                          {["STREAM","t/day FW","t/day DM","N kg/day","P kg/day","K kg/day","C:N"].map((h,i)=>(
                            <td key={i} style={{padding:"9px 12px", color:C.grey, fontWeight:700,
                              ...
                              borderBottom:`1px solid ${C.inputSectionBg}`}}>{h}</td>
                          ))}
                        </tr>
                      </thead>
                      <tbody>
                        {[
                          ...
                          <tr key={i} style={{borderBottom:`1px solid ${C.inputSectionBg}33`,
                            background:i%2===0?C.navyDk+"80":"transparent"}}>
                            <td style={{padding:"9px 12px", color:row.col, fontWeight:700}}>{row.name}</td>
                            <td style={{padding:"9px 12px", color:C.greyLt, fontFamily:"'DM Mono', monospace"}}>{row.fw}</td>
                            <td style={{padding:"9px 12px", color:C.greyLt, fontFamily:"'DM Mono', monospace"}}>{row.dm}</td>
                            <td style={{padding:"9px 12px", color:C.green, fontFamily:"'DM Mono', monospace", fontWeight:700}}>{row.n}</td>
                            <td style={{padding:"9px 12px", color:C.teal, fontFamily:"'DM Mono', monospace"}}>{row.p}</td>
                            <td style={{padding:"9px 12px", color:C.amber, fontFamily:"'DM Mono', monospace"}}>{row.k}</td>
                            <td style={{padding:"9px 12px", color:C.greyLt, fontFamily:"'DM Mono', monospace"}}>{row.cn}</td>
                          </tr>
                        ))}
                        <tr style={{background:C.green+"14", borderTop:`2px solid ${C.green}44`}}>
                          ...
                          <td style={{padding:"10px 12px", color:C.green, fontFamily:"'DM Mono', monospace", fontWeight:700}}>—</td>
                          <td style={{padding:"10px 12px", color:C.green, fontFamily:"'DM Mono', monospace", fontWeight:700}}>
                            {(efbDMpd+opdcDMreq+pomeSludgeInclDM+pkeDM).toFixed(1)}
                          </td>
                          <td style={{padding:"10px 12px", color:C.green, fontFamily:"'DM Mono', monospace", fontWeight:900}}>{totN}</td>
                          <td style={{padding:"10px 12px", color:C.teal, fontFamily:"'DM Mono', monospace", fontWeight:700}}>{totP}</td>
                          <td style={{padding:"10px 12px", color:C.amber, fontFamily:"'DM Mono', monospace", fontWeight:700}}>{totK}</td>
                          <td style={{padding:"10px 12px", color:C.white, fontFamily:"'DM Mono', monospace", fontWeight:700}}>{blendCN||"—"}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
