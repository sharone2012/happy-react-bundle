...
export default function CFI_EFB_DM_Calc() {
  ...
  const _calcData  = useSelector(function(s) { return s.calc.results['efb-dm'] || null; });
  const loading    = useSelector(function(s) { return s.calc.loading['efb-dm'] || false; });

  useEffect(function() {
    dispatch(runCalc({ name: 'efb-dm', body: { ffb, util, hrs, days, yieldPct, mc, lockedMC } }));
  ...
  var efbFWhr    = (_calcData && _calcData.efbFWhr)    || 0;
  var efbFWday   = (_calcData && _calcData.efbFWday)   || 0;
  var efbFWmonth = (_calcData && _calcData.efbFWmonth) || 0;
  var efbDMhr    = (_calcData && _calcData.efbDMhr)    || 0;
  var efbDMday   = (_calcData && _calcData.efbDMday)   || 0;
  var efbDMmonth = (_calcData && _calcData.efbDMmonth) || 0;
  ...
  var lockedRow  = (_calcData && _calcData.lockedRow)  || { mc: mc, fw: 0, dm: 0, water: 0, pctFFB: 0 };
  ...
  return React.createElement("div", {
    ...
    React.createElement("div", { style:{ maxWidth:920, margin:"0 auto", padding:"16px 14px" } },
      ...
      loading ? React.createElement("div", { style:{ display:"flex", alignItems:"center", justifyContent:"center", gap:8, padding:"8px 14px", background:C.green+"11", borderBottom:"1px solid "+C.green+"33", color:C.green, fontSize:12, letterSpacing:"0.05em" } },
        React.createElement("div", { style:{ width:14, height:14, border:"2px solid "+C.green+"55", borderTopColor:C.green, borderRadius:"50%", animation:"cfi-spin 0.7s linear infinite" } }),
        "Calculating\u2026"
      ) : null,
