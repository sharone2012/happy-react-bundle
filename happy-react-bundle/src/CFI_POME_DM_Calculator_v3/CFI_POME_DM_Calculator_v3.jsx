...
export default function CFI_POME_DM_v3() {
  ...
  const _calcData  = useSelector(function(s) { return s.calc.results['pome-dm'] || null; });
  const loading    = useSelector(function(s) { return s.calc.loading['pome-dm'] || false; });

  useEffect(function() {
    dispatch(runCalc({ name: 'pome-dm', body: { ffb, util, hrs, days, scenario, dmPoint, lockedMC } }));
  }, [ffb, util, hrs, days, scenario, dmPoint, lockedMC, dispatch]);
