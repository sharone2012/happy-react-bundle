  ...
  useEffect(() => {
    ...
    async function loadSiteData() {
      ...
      if (mr.latitude && mr.longitude) {
        try {
          const meteoUrl = `https://api.open-meteo.com/v1/forecast?latitude=${mr.latitude}&longitude=${mr.longitude}&daily=temperature_2m_max,temperature_2m_min,precipitation_sum&timezone=auto&past_days=365&forecast_days=1`;
