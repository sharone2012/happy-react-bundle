...
import CFI_SoilAcidity_Lookup from "@/CFI_SoilAcidity_Lookup/CFI_SoilAcidity_Lookup.jsx";
  ...
  useEffect(() => {
    try {
      sessionStorage.setItem("cfi-s0-display", JSON.stringify({
        plantName:   s0.plantName,
        estateName:  s0.estateName,
        millName:    s0.millName,
        ffbCapacity: s0.ffbCapacity,
        soil:        s0.soil,
        efbEnabled:  s0.efbEnabled,
        opdcEnabled: s0.opdcEnabled,
        posEnabled:  s0.posEnabled,
        pomeEnabled: s0.pomeEnabled,
      }));
      window.dispatchEvent(new Event("cfi-s0-updated"));
    } catch {}
