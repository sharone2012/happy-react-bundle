...
import { fetchOrganisms, insertOrganism, removeOrganism, addOrganismLocal } from '../store/slices/bioSlice';
...
export default function CFIBioManager() {
  ...
  const organisms  = useSelector(function(s) { return s.bio.organisms.length > 0 ? s.bio.organisms : SEED_ORGANISMS; });
  const loading    = useSelector(function(s) { return s.bio.loadingFetch; });
  ...
  async function handleAdd(e) {
    ...
    dispatch(addOrganismLocal(newOrg));
    setNextId(nextId + 1);
    dispatch(insertOrganism(newOrg));
